...
@shared_task(name='celery_tasks.execute_engine_arquivopt', bind=True, soft_time_limit=300)
...
@shared_task(name='celery_tasks.execute_engine_tlscovid', bind=True, soft_time_limit=300)
